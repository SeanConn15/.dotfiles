...
theme.bg_normal     = theme.light1
theme.bg_focus      = theme.light0
theme.bg_urgent     = theme.red
theme.bg_minimize   = theme.dark2
theme.bg_systray    = theme.dark2

theme.fg_normal     = theme.dark 
theme.fg_focus      = theme.dark 
theme.fg_urgent     = theme.dark 
theme.fg_minimize   = theme.light1
...
theme.wallpaper = "/home/sean/Documents/wallpaper.jpg"
